...
class Timecop
  ...
  # source://timecop//lib/timecop/timecop.rb#152
  def baseline=(b); end

  # source://timecop//lib/timecop/timecop.rb#225
  def return(&block); end

  # source://timecop//lib/timecop/timecop.rb#240
  def return_to_baseline; end

  # source://timecop//lib/timecop/timecop.rb#165
  def set_baseline(b); end

  # source://timecop//lib/timecop/timecop.rb#182
  def set_stack(s); end

  # source://timecop//lib/timecop/timecop.rb#173
  def stack; end

  # source://timecop//lib/timecop/timecop.rb#201
  def thread_safe; end

  # source://timecop//lib/timecop/timecop.rb#196
  def thread_safe=(t); end

  # @raise [SafeModeException]
  #
  # source://timecop//lib/timecop/timecop.rb#205
  def travel(mock_type, *args, &block); end

  # source://timecop//lib/timecop/timecop.rb#235
  def unmock!; end
  ...
  class << self
    ...
    # source://timecop//lib/timecop/timecop.rb#146
...
class Timecop::SafeModeException < ::StandardError
  ...
  #
  # source://timecop//lib/timecop/timecop.rb#249
  def initialize; end
end
